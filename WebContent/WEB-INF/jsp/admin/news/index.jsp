                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              ...
                              <tr>
								 <td>${objNew.id }</td>
                                 <td>${objNew.name }</td>
                                  <td>${objNew.preview }</td>
                                  <td>${objNew.date }</td>
                                 <td><img alt="${objNew.name }" class="img-rounded" style="width: 127px; height: 89px;" src="${pageContext.request.contextPath }/files/${objNew.picture }" /></td>
                                 <td>
                                  <div class="btn-group">
                                  <ul class="nav nav-tabs">
                                  	<li><a class="btn btn-primary" href="${pageContext.request.contextPath }/admin/new/edit/${objNew.id }"><i class="icon_pencil-edit_alt"></i></a></li>
                                	<li><a class="btn btn-danger" onclick="return confirm('Bạn có muốn xóa không')" href="${pageContext.request.contextPath }/admin/new/del/${objNew.id}"><i class="icon_close_alt2"></i></a></li>
                                  </ul>
                                  </div>
                                  </td>
                              </tr>
