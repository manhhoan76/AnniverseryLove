                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath }/admin/new/edit/${objNew.id}">
                                  ...
                                  <div class="panel-body">
                                      <div class="form">
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <textarea class="form-control ckeditor" id="editor1" rows="6" name="preview">${objNew.preview }</textarea>
                                                  		<form:errors path="objNew.preview" cssStyle="color :red;"></form:errors>
                                                  </div>
                                              </div>
                                      </div>
                                  </div>
                                  ...
                                  <div class="panel-body">
                                      <div class="form">
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <textarea name="detail" class="form-control ckeditor" id="editor2" rows="6">${objNew.detail }</textarea>
                                                 		 <form:errors path="objNew.detail" cssStyle="color :red;"></form:errors>
                                                  </div>
                                              </div>
                                      </div>
                                  </div>
								...
								<div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control round-input" value="${objNew.date }" name="date">
                                           <form:errors path="objNew.date" cssStyle="color :red;"></form:errors>
                                      </div>
                                  </div>
                                 <div class="form-group">
