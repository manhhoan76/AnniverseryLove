  ...
  <!-- 
	...
	<body>
		...
		<div class="fh5co-hero" data-section="home">
			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(templates/public/images/2b.jpg);">
				<div class="display-t">
					<div class="display-tc">
						<div class="container">
							<div class="col-md-10 col-md-offset-1">
								<div class="animate-box">
									<h1>-- Tất cả ảnh của anh và em đó tình yêu -- </h1>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h2>Những hình ảnh mang đầy kỷ niệm</h2>
					</div>
				</div>
				
				<div class="row">
				<c:forEach  items="${listPic }" var="objPic">
					<div class="col-md-4">
						<div class="gallery animate-box">
							<a class="gallery-img image-popup image-popup" href="${pageContext.request.contextPath }/files/${objPic.name }"><img src="${pageContext.request.contextPath }/files/${objPic.name }" class="img-responsive" alt="${objPic.name }"></a>
						</div>
					</div>
					</c:forEach>
				</div>
