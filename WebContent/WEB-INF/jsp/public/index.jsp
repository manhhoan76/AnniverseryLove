  ...
  <!-- 
	...
	<body>
		...
		<div class="fh5co-hero" data-section="home">
			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(templates/public/images/3.jpg);">
				<div class="display-t">
					<div class="display-tc">
						<div class="container">
							<div class="col-md-10 col-md-offset-1">
								<div class="animate-box">
									<h1>The 1 Year Anniversary</h1>
									<h2>Mạnh Hoan <i class="icon-heart"></i> Hồng Hà</h2>
									<p><span>12.12.2017</span></p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row row-bottom-padded-md animate-box">
					<div class="col-md-6 col-md-offset-3 text-center">
						<div class="col-md-5 col-sm-5 col-xs-5 nopadding">
							<img src="${pageContext.request.contextPath }/templates/public/images/h.jpg" class="img-responsive" alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
							<h3><strong>Mạnh Hoan</h3>
						</div>
						<div class="col-md-2 col-sm-2 col-xs-2 nopadding"><h2 class="amp-center"><i class="icon-heart"></i></h2></div>
						<div class="col-md-5 col-sm-5 col-xs-5 nopadding">
							<img src="${pageContext.request.contextPath }/templates/public/images/hh.jpg" class="img-responsive" alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
							<h3><strong>Hồng Hà</strong></h3>
						</div>
					</div>
				</div>
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2">
						<div class="col-md-12 text-center heading-section">
							<h2>Thời khắc định mệnh</h2>
							<h3><strong>12-12-2016 &mdash; Biển Nguyễn Tất Thành, Đà Nẵng</strong></h3>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="fh5co-started" style="background-image:url(templates/public/images/1m.jpg);" data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
			<div class="container">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center heading-section">
						<h2>Tình yêu của anh ơi! ^ ^</h2>
						<p style="font-size:27px;">Anh làm web này để kỷ 1 năm của chúng ta, em hãy cùng anh nhìn lại một năm qua nha. Ở đó em sẽ gặp lại những kỷ niệm đã qua, những niềm vui, nỗi buồn mà chúng ta đã cùng nhau trải qua. Một năm đã qua và anh biết anh yêu em rất rất nhiều. Yêu em nhiều lắm tình yêu của anh ạ. <3 <3 <3 
					</div>
				</div>
			</div>
		</div>
